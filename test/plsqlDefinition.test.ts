...
suite('PLSQL Definition', () => {
    ...
    test('Package', (done) => {
        let testCases: ICase[] = [
            ...
            buildCase([53, 6], 'MyFunc', [0,0], 'xyz_myFunc.sql')             // body to a function file
        ];
    ...
    test('Separate package body', (done) => {
        let testCases: ICase[] = [
            ...
            buildCase([30,16], 'myCall', [41,2], 'xyz_myPackage.sql'),         // body to body in another package
    ...
    test('Function', (done) => {
        let testCases: ICase[] = [
            buildCase([15,12], 'myCall', [41,2], 'xyz_myPackage.sql'),         // function to package
            buildCase([16,16], 'myNestedFunc', [7,2], 'xyz_myFunc.sql'),       // function to nested function
        ];
    ...
    test('Dml', (done) => {
        let testCases: ICase[] = [
            buildCase([1,25], 'set_myValue', [32,2], 'xyz_myPackage.sql'),     // dmt to package
        ];
