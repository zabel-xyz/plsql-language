...
// Visit a parse tree produced by PlSqlParser#namespace.
PlSqlParserVisitor.prototype.visitNamespace = function(ctx) {
  return this.visitChildren(ctx);
};
...
PlSqlParserVisitor.prototype.visitRelational_properties = function(ctx) {
  return this.visitChildren(ctx);
};
...
// Visit a parse tree produced by PlSqlParser#selected_element.
PlSqlParserVisitor.prototype.visitSelected_element = function(ctx) {
  return this.visitChildren(ctx);
};
